...
public class DexUtil {
    ...
    public static void insertDex(DexClassLoader dexClassLoader, ClassLoader baseClassLoader, File nativeLibsDir) throws
        Exception {
    ...
    public static void insertDex(ClassLoader plugin, ClassLoader host) throws Exception{
        Object hostDexElements = getDexElements(getPathList(host));
        Object pluginDexElements = getDexElements(getPathList(plugin));
        Object allDexElements = combineArray(hostDexElements, pluginDexElements);
        Object pathList = getPathList(plugin);
        Reflector.with(pathList).field("dexElements").set(allDexElements);
    }
    ...
    private static synchronized void insertNativeLibrary(DexClassLoader dexClassLoader, ClassLoader baseClassLoader, File nativeLibsDir) throws
        Exception {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            Object
                allNativeLibraryPathElements = Array.newInstance(elementClass, baseArrayLength + 1);
